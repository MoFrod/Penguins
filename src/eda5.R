...
bartlett.test(body_mass_g ~ island, data = Abd) # p-value is greater than 0.05, so the assumption of equal variance is valid.

##t-test for hypothesis
t.test(body_mass_g ~ island, data = Abd, var.equal = T)  # p-value is greater than 0.1, no evidence against the body mass being the same across both islands
...
##Test equal variance b/w Dream and Biscoe
bartlett.test(body_mass_g ~ island, data = Adt) # p-value is greater than 0.05, so the assumption of equal variance is valid.

##t-test for hypothesis
t.test(body_mass_g ~ island, data = Adt, var.equal = T)  # p-value is greater than 0.1, no evidence against the body mass being the same across both islands

# Dream has larger bill length than Biscoe

##Test equal variance b/w Dream and Biscoe
bartlett.test(bill_length_mm ~ island, data = Abd) # p-value is greater than 0.05, so the assumption of equal variance is valid.

##t-test for hypothesis
t.test(bill_length_mm ~ island, data = Abd, var.equal = T)  # p-value is greater than 0.1, no evidence against the body mass being the same across both islands
...
##t-test for hypothesis
t.test(bill_length_mm ~ island, data = Abt, var.equal = T)  # p-value is greater than 0.5
...
##Test equal variance
bartlett.test(bill_depth_mm ~ island, data = Atb) # p-value is less than 0.05, so the assumption of equal variance is not valid.

##t-test for hypothesis
t.test(bill_length_mm ~ island, data = Atb, var.equal = F) # p-value is greater than 0.5
...
##t-test for hypothesis
t.test(bill_length_mm ~ island, data = Adt, var.equal = F) # p-value is greater than 0.5

# Torgersen has larger flipper length than Biscoe

##Test equal variance
bartlett.test(flipper_length_mm ~ island, data = Atb) # p-value is greater than 0.05, so the assumption of equal variance is valid.

##t-test for hypothesis
t.test(flipper_length_mm ~ island, data = Atb, var.equal = T) # p-value is  0.48
...
##t-test for hypothesis
t.test(flipper_length_mm ~ island, data = Adt, var.equal = F) # p-value is 0.9
